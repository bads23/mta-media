        ...
        <tbody>
            ...
            <tr>
                <td style="padding: 20px">
                    ...
                    <p>An order <b>(1-RFVKSK-161019)</b> on the Motion Talent Africa Store has just been made by Steve Karuma (stevekaruma@gmail.com). Head over to the <a href="#" style="color: #d4af37">dashboard </a> to confirm the order.</p>
